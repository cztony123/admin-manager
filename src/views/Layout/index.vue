<template>
    <div>
        ...
        <div class="header">
            ...
            <el-dropdown>
                ...
                <el-dropdown-menu slot="dropdown">
                    ...
                    <el-dropdown-item icon="el-icon-switch-button" @click.native="loginOut">退出系统</el-dropdown-item>
                </el-dropdown-menu>
            </el-dropdown>
        </div>
        ...
        <!-- 左侧导航 -->
        <div class="navbar">
            <el-menu default-active="1" :router="true" background-color="#545c64" text-color="#fff" acive-text-color="#ffd04b">
        ...
        <div class="main">
            <el-breadcrumb separator-class="el-icon-arrow-right" v-show="$route.path !='/'">
                ...
                <el-breadcrumb-item v-show="$route.path=='/stockQuery' || $route.path== '/kucunsearch' || $route.path== '/rukusearch'">库存管理</el-breadcrumb-item>
